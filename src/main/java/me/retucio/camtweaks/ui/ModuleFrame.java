...
import me.retucio.camtweaks.ui.settings.BindButton;
import me.retucio.camtweaks.ui.settings.CycleButton;
import me.retucio.camtweaks.ui.settings.SettingButton;
import me.retucio.camtweaks.ui.settings.SliderButton;
...
public class ModuleFrame {
    ...
    public ModuleFrame(int x, int y, int w, int h) {
        ...
        int offset = h;
        for (Module module : CameraTweaks.moduleManager.getModules()) {

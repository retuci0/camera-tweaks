...
// interfaz para los colores, para no repetirme (regla DRY)
...
public class Colors {
    ...
    public static int hoveredCycleButtonColor = new Color(70, 70, 70, 180).getRGB();
    public static int cycleButtonColor = new Color(50, 50, 50, 150).getRGB();
